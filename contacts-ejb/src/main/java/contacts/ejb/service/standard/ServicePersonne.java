...
public class ServicePersonne implements IServicePersonne {
	...
	@Override
	public int inserer(DtoParent dtoPersonne) throws ExceptionValidation {
	...
	@Override
	public void modifier(DtoParent dtoPersonne) throws ExceptionValidation {
		verifierValiditeDonnees(dtoPersonne);
	...
	public DtoParent retrouver(int idPersonne) {
	...
	private void verifierValiditeDonnees(DtoParent dtoPersonne) throws ExceptionValidation {
		...
		for (DtoGestionnaire telephoe : dtoPersonne.getTelephones()) {
